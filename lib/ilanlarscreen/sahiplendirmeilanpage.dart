...
class _SahiplendirmeIlanPageState extends State<SahiplendirmeIlanPage> {
  ...
  Widget build(BuildContext context) {
    CollectionReference sahiplendirmeIlan = FirebaseFirestore.instance.collection('sahiplendirmeilantable');
  ...
  children: snapshot.data!.docs.map((DocumentSnapshot document) {
    ...
    Color cardColor;
      ...
      cardColor = (data['cinsiyet'] == 'Dişi') ? Colors.pinkAccent.shade100.withOpacity(0.8) : Colors.blue.shade800.withOpacity(0.6);
  ...
  child: ClipRRect(
    ...
    child: Stack(
      children: [ 
        ...
        ),  if (isPremium) // Eğer premium ise, köşede bir etiket göster
          Positioned(
            right: 0,
            top: 0,
            child: Container(
              padding: EdgeInsets.symmetric(horizontal: 8, vertical: 4),
              color:  (data['cinsiyet'] == 'Dişi') ? Colors.pink.shade400.withOpacity(0.9) : Colors.blue.shade600.withOpacity(0.9),
              child: Text(
                'Öne Çıkan',
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 2),
                  Text('Sahiplendirme', style: TextStyle(color: Colors.white)),
                ],
        ),),
