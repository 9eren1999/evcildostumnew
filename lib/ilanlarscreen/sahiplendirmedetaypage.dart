...
class SahiplendirmeDetayScreen extends StatelessWidget {
  final String documentId; // İlanın belge ID'si

  SahiplendirmeDetayScreen({required this.documentId});

  @override
  Widget build(BuildContext context) {
    CollectionReference ilanlar = FirebaseFirestore.instance.collection('sahiplendirmeilantable');
