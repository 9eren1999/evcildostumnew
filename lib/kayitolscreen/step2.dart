...
class _Step2PageState extends State<Step2Page> {
 ...
 String? _selectedBreed;
  ...
  Future<String> uploadImage(File imageFile) async {
    ...
    Reference ref = FirebaseStorage.instance.ref().child('pets_images/$fileName');
  ...
  if (_formKey.currentState!.validate() && _imageFile != null) {
    ...
    final CollectionReference pets = users.doc(currentUser!.uid).collection('pets');
    ...
    if (_imageFile == null && showError)
      Padding(
        ...
        child: Text(
          ...
          style: TextStyle(color: Colors.red), // Hata mesajı kırmızı renkte
        ),
      ),
  ],
),
...
TextFormField(
  ...
  onSaved: (value) => _kilo = value!, // _kilo bir üye değişken olmalıdır.
  validator: (value) {
    if (value!.isEmpty) {
...
// Cinsiyet seçimi için DropdownButton

// Tür seçimi için DropdownButton
...
// Irk seçimi için DropdownButton
