...
class _IsimOnericiPageState extends State<IsimOnericiPage> {
    ...
    setState(() {
      if (secilenTur != null && secilenCinsiyet != null) {
        ...
        if (possibleNames != null &&
            detailedIsimListesi.length < possibleNames.length) {
          var namesToAdd = min(30 - detailedIsimListesi.length,
              possibleNames.length - detailedIsimListesi.length);
          detailedIsimListesi.addAll(possibleNames.sublist(
              detailedIsimListesi.length,
              detailedIsimListesi.length + namesToAdd));
        }
      }
    });
  }
  ...
  Widget buildCardChoice(String title, List<String> options,
            ...
            SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: secilenTur != null && secilenCinsiyet != null
                      ...
                      : null,
                  child:
                      Text('İsimleri Listele', style: TextStyle(fontSize: 16)),
                ))
          ],
        ),
      ),
